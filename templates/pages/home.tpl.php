<section class="hero">
    ...
    <section class="grid">
        <article class="card">
            ...
            <p>Each notebook is cleaned, checked and prepared before sale.</p>
        </article><article class="card"><h3>Database driven</h3>
        <p>The CRUD page reads notebook records from MySQL and joins processor and operating system details.</p>
    </article><article class="card"><h3>Responsive design</h3><p>The layout works on laptop and mobile screens using flexible CSS grids.</p>
</article>
</section>
<section class="media-box">
    ...
    <div class="card">
        ...
        width="560" 
        height="315" 
        src="https://www.youtube.com/embed/D3zZ-HW1PG8"
